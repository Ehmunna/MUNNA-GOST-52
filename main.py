...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY MG24 GAMER 
"""
            else:
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]MG24 GAMER    
[FFD700]✨ কেউ GUILD BOT কিনতে চাইলে telegram এ message করবেন, telegram username @MG24_GAMER ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> MG24 GAMER ❄️  ⚡
"""
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]EH GOST BOT
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]EH GOST 2
[00FFFA]╚═•══•════════════════•══•═╝"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To MG24 GAMER's BOT"
...
│  └─ [00AAFF]/evo [uid] [1-21]
├─ [00FF00]Fast Evo (25x)
│  └─ [00AAFF]/evo_fast [uid] [1-21]
├─ [00FF00]Custom Evo (X times)
│  └─ [00AAFF]/evo_c [uid] [1-21] [x]
...
[00FF00]━━━━━━━━━━━━[00AAFF]"""
                            ...
                            # ───── AI & Utility Commands ─────
                            ai_commands = """[C][B][00AAFF]═══⚡ TOOLS & FUN COMMANDS ⚡═══[00FF00][B]
├─ [00FF00]Get player bio by uid
│  └─ [00AAFF]/bio [uid]
├─ [00FF00]Fetch Instagram User Info
│  └─ [00AAFF]/ig [username]
├─ [00FF00]Send custom spam message
│  └─ [00AAFF]/ms <text>
├─ [00FF00]Ask AI Anything
│  └─ [00AAFF]/ai [question]
├─ [00FF00]Admin Information
│  └─ [00AAFF]/admin
└─ [00FF00]Bot Status Check
   └─ [00AAFF]/status
[00FF00]━━━━━━━━━━━━[00AAFF]"""
...
[00FF00]━━━━━━━━━━━━[00AAFF]"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # ───── info Commands ─────
                            info_commands = """[C][B][00AAFF]═══⚡ TOOLS & FUN COMMANDS ⚡═══[00FF00][B]
├─ [00FF00]Get player basic info
│  └─ [00AAFF]/info [uid]
├─ [00FF00]Check account ban status
│  └─ [00AAFF]/check [uid]
├─ [00FF00]Add bot in friend list
│  └─ [00AAFF]/add [uid]
├─ [00FF00]Remove from friend list
│  └─ [00AAFF]/remove [uid]
├─ [00FF00]Spam Friend Requests 
│  └─ [00AAFF]/spam_req [uid]
└─ [00FF00]Gali any friend
   └─ [00AAFF]/gali [name]
[00FF00]━━━━━━━━━━━━[00AAFF]"""
...
[FF1493]║ ⚡ [B][FFFF00]BOT INFO[FFFF00][/B] ⚡
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]EH MUNNA GOST
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]EH GOST 2
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4350805021','071D800512E554B460FE06725F76E9E8E14D9E19E9E54FB055C178EF58534D96'
    ...
    os.system('clear')
    print(render('MUNNA GAMERs', colors=['white', 'green'], align='center'))
    print('')
    print("🥷 EH MUNNA BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
